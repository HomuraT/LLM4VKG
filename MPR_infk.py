"""
映射模式识别 - 使用 infk 数据版本 (Mapping Pattern Recognition - Using infk data, MPR_infk)
...
if __name__ == "__main__":
    ...
    for dbname in tqdm(dbnames):
        ...
        base_path = f'./outputs/mapping_patterns_infk/{dbname}'
        ...
        # 保存 table_info.pt 供 OC_MG_infk.py 使用
